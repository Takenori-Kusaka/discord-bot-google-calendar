...
class WeatherClient:
    def __init__(self, latitude, longitude):
        ...
        self.retry_session = retry_requests.retry(self.cache_session, retries=5, backoff_factor=0.2)
    ...
    def get_weather_data(self, time_range):
        logger.info(f"Starting weather data retrieval for {time_range} at lat:{self.latitude}, lon:{self.longitude}")
        try:
